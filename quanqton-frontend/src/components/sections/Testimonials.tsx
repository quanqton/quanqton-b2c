...
const testimonials = [
    ...
    { id: 2, name: "Cliente QuanQton", location: "QUANQTON", time: "Uso Diário", text: "O sal simplesmente curou algum problema no meu sistema digestivo. Eu tinha azia toda noite. Comecei a usar uma pitada toda manhã antes do desjejum e o alívio foi imediato. Esse sal mudou minha vida.", initial: "C" },
    { id: 3, name: "Cliente QuanQton", location: "QUANQTON", time: "Melhora no sono", text: "Minhas dores de endometriose sumiram. Não sinto mais cólicas, meu fluxo de 9 dias está em 5 dias. Minha mente está mais calma, sou outra pessoa. O sono está muito bom - durmo a noite toda.", initial: "C" },
    ...
    return (
        <section id="depoimentos" className="relative bg-brand-bg overflow-hidden py-20 md:py-32 border-t border-white/5">
            ...
            <div className="container-custom relative z-10 mb-12">
                <FadeIn>
                    <h2 className="mb-0 text-center uppercase">Veja o que nossos clientes dizem</h2>
                    <p className="text-center text-[16px] text-white/55 font-normal mt-[12px]">E os benefícios que sentem</p>
                </FadeIn>
            </div>
            ...
            <div className="relative z-10 w-full overflow-hidden">
                <div className="relative group">
                    ...
                    <div
                        ...
                        className="flex overflow-x-auto gap-4 pl-0 ml-0 pr-6 w-full pb-12 snap-x snap-mandatory [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]"
                    >
                        {testimonials.map((t, index) => (
                            <FadeIn key={t.id} delay={Math.min(index * 0.05, 0.5)} className="shrink-0 snap-start w-[280px] md:w-[400px]">
